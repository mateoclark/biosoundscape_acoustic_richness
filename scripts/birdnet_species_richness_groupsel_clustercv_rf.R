# Purpose: Random forest modeling of species richness from BirdNET embedding statistics
...
predictor_files <- c(
  ...
  # BirdNET embedding descriptive statistics
  "birdnet_embeddings_minutes_nonzero_mean_dawn-dusk_AGI90_descriptive_statistics.csv", 
  "birdnet_embeddings_minutes_nonzero_mean_dawn-dusk_AGI75_descriptive_statistics.csv",
  "birdnet_embeddings_minutes_nonzero_mean_dawn-dusk_AGI50_descriptive_statistics.csv",
  "birdnet_embeddings_minutes_nonzero_mean_dawn-dusk_descriptive_statistics.csv",

  
  # BirdNET embedding harmonic statistics
  "birdnet_embeddings_minutes_nonzero_mean_AGI90_2phase-harmonic_statistics.csv", 
  "birdnet_embeddings_minutes_nonzero_mean_AGI75_2phase-harmonic_statistics.csv",
  "birdnet_embeddings_minutes_nonzero_mean_AGI50_2phase-harmonic_statistics.csv",
  "birdnet_embeddings_minutes_nonzero_mean_2phase-harmonic_statistics.csv"
...
for (predictor_file in predictor_files){
  ...
  save(dry_models, file = file.path(inDir,"models/rf_birdnet",outfile))
  
  outfile <- sub("\\.csv$", "_wet_season.RData", predictor_file)
  save(wet_models, file = file.path(inDir,"models/rf_birdnet",outfile))
  
  outfile <- sub("\\.csv$", "_dry-wet_season.RData", predictor_file)
  save(drywet_models, file = file.path(inDir,"models/rf_birdnet",outfile))
